...
public class UserProfileForAi {
    ...
    public static UserProfileForAi from(UserInfoResponseDTO info,
        ...
        var b = UserProfileForAi.builder()
                ...
                .budget(info.getBudget() != null ? info.getBudget().name() : null)
        ...
        if (prefs != null) {
            b.travelStyle(prefs.getTravelStyle() != null ? prefs.getTravelStyle().name() : null)
                    ...
                    .activityLevel(prefs.getActivityLevel() != null ? prefs.getActivityLevel().name() : null)
                    .cuisinePreferences(prefs.getCuisinePreferences())
                    .preferredClimate(prefs.getPreferredClimate() != null ? prefs.getPreferredClimate().name() : null)
                    .tripPace(prefs.getTripPace() != null ? prefs.getTripPace().name() : null)
                    .accommodationType(
                            prefs.getAccommodationType() != null ? prefs.getAccommodationType().name() : null)
                    .transportPreference(
                            prefs.getTransportPreference() != null ? prefs.getTransportPreference().name() : null)
                    ...
                    .dailyBudget(prefs.getDailyBudget() != null ? prefs.getDailyBudget().toPlainString() : null)
