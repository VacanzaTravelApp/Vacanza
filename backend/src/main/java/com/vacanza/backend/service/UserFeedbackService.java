...
public class UserFeedbackService {
    ...
    public void record(User user, PoiFeedbackEventRequestDTO req) {
        ...
        String poiKey = resolvePoiStorageKey(req.foursquareId(), req.mapboxId());
        if (poiKey != null) {
    ...
    private static String resolvePoiStorageKey(String foursquareId, String mapboxId) {
        String fs = PoiFeedbackKeyUtil.foursquareKey(foursquareId);
        if (fs != null) {
            return fs;
        }
        return PoiFeedbackKeyUtil.mapboxKey(mapboxId);
    }
