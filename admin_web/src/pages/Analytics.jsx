...
export default function Analytics() {
    ...
    const handleSync = () => {
        // Silent sync as per user's cleanup request
    };
    ...
    return (
        ...
        >
            ...
            <Row gutter={[16, 16]} style={{ marginTop: "24px" }}>
                ...
                <Col xs={24} lg={8}>
                    <Card
                        title={<Space><GlobalOutlined /> User Base Distribution</Space>}
                        variant="borderless"
                        styles={{ body: { height: 400 } }}
                        loading={isLoading}
                        style={{ borderRadius: 12 }}
                    >
                        <div style={{ height: '300px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <ResponsiveContainer width="100%" height={250}>
                                <PieChart>
                                    <Pie
                                        data={[
                                            { name: 'Admin', value: 2 },
                                            { name: 'Regular Users', value: analytics?.totalUsers ? analytics.totalUsers - 2 : 5 }
                                        ]}
                                        cx="50%"
                                        cy="50%"
                                        innerRadius={60}
                            ...
                            <div style={{ textAlign: 'center', marginTop: 16 }}>
                                <Text strong>Usage Statistics Summary</Text>
                            </div>
                        </div>
                    </Card>
                </Col>
            ...
            <Row gutter={[16, 16]} style={{ marginTop: "24px" }}>
                <Col span={24}>
                    <Card
                        title="Platform Utilization Audit"
                        variant="borderless"
                        style={{ borderRadius: 12 }}
                    >
                        <Paragraph>
                            Based on **FReq13**, the administrative dashboard provides Oversight of system usage.
                            The statistics above are aggregated from system logs and service metrics in real-time.
                        </Paragraph>
                        <Progress percent={92} status="active" strokeColor="#52c41a" style={{ maxWidth: 400 }} />
                        <Text type="secondary">System resource utilization (optimized)</Text>
                    </Card>
                </Col>
            </Row>
        </motion.div>
