      ...
      child: AnimatedContainer(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              'Round trip',
              style: BookingSearchFieldStyles.inlineControlLabel(context).copyWith(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: isLight
            ...
            : null,
        color: isLight ? null : cs.surfaceContainerHighest.withValues(alpha: 0.40),
